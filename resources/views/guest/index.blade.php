...
<body class="">
    <div class="h-screen w-full flex items-center justify-center flex-col relative">
        ...
        <div id="notification-success"
            class="transition-opacity duration-500 fixed mx-6 md:mx-0 top-5 md:right-5 shadow-lg rounded-lg bg-white p-4 flex items-center justify-between md:w-full max-w-md border border-green-300 opacity-100">
        ...
        <div id="notification-error"
            class="transition-opacity duration-500 fixed mx-6 md:mx-0 top-5 md:right-5 shadow-lg rounded-lg bg-white p-4 flex items-center justify-between md:w-full max-w-md border border-red-300 opacity-100">
            <div class="flex items-center">
                <div class="pr-4">
        ...
        <div id="notification-warning"
            class="transition-opacity duration-500 fixed mx-6 md:mx-0 top-5 md:right-5 shadow-lg rounded-lg bg-white p-4 flex items-center justify-between md:w-full max-w-md border border-orange-300 opacity-100">
            <div class="flex items-center">
                <div class="pr-4">
        ...
        <!-- Toast for seat number notification
